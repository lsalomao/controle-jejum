...
server {
    listen 80;
    server_name fasting.ledtech.app;
    ...
    location /static/ {
        alias /opt/fasting-life/staticfiles/;
        expires 30d;
        add_header Cache-Control "public, immutable";
    }

    location /media/ {
        alias /opt/fasting-life/media/;
        expires 7d;
...
docker cp fasting_web:/app/staticfiles/. $PROJECT_DIR/staticfiles/ 2>/dev/null || true
docker cp fasting_web:/app/media/. $PROJECT_DIR/media/ 2>/dev/null || true
